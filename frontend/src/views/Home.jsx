    ...
    return (
        <div className='sm:mt-0 mt-20 h-screen w-full flex items-center justify-center  flex-col'>
            ...
            <div className=' grid grid-cols-1  w-full sm:grid-cols-3'>
                <AddModal isOpen={isAddModalOpen} setOpen={handleModalClose} fetchMaterial={fetchMaterial} />
                <div className=' col-span-2 p-5 '>
                    <MyTable data={materiels} />
                </div>
            ...
            <div className={`fixed bottom-5 text-white flex items-center justify-center right-3 p-3 w-[65px] h-[65px] rounded-full transition-all transform ${isClicked ? 'shadow-inner' : 'shadow-lg'
