...
function AddModal({ isOpen, setOpen, fetchMaterial }) {
    ...
    return (
        <div onClick={(e) => {
            ...
            <form onSubmit={handleSubmit} className='bg-white rounded-md lg:min-w-[400px] md:min-w-[300px] min-w-full animate-fade-in-down animate-bounce  w-full p-5 space-y-4'>
